...
public class InterfaceMethodrefInfoConstant implements ConstantPoolInfo
{
	/**
	...
	public InterfaceMethodrefInfoConstant(int classIndex, int nameAndTypeIndex)
	{
	...
	{
		return ConstantPoolTag.INTERFACE_METHODREF;
	}
